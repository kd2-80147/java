...
public class Point2D_Ques_4 {
	int x;
	int y;
	public Point2D_Ques_4() {
		super();
	}

	public Point2D_Ques_4(int x, int y) {
		super();
		this.x = x;
		this.y = y;
	}
	...
	public boolean isEqual(Point2D_Ques_4 p1) {
		if(p1.x == this.x && p1.y == this.y)
			return true;
		else 
			return false;
	}
	public void addPoint(Point2D_Ques_4 p1) {
		double ans;
